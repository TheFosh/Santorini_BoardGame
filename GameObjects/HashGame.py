...
## of Santorini using a hash board object.            ##
########################################################
## Author: Jake Swanson
...
class HashGame:
    ...
    def get_move_spots(self, player_index):
        ...
        possible_move_locations = self.HashBoard.get_spaces_around(current_player)
    ...
    def move_player(self, picked_player, picked_location):
        ...
        self.HashBoard.update_player_space(current_player, picked_location)
    ...
    def build_at_spot(self, picked_location):
        ...
        :return: Nothing
        """
        self.HashBoard.build_on_space(picked_location)
